                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            <label class="gallery" for="image">Image
                                @if($post->image)
                                    <img src="{{ asset($post->image) }}" alt="{{ $post->slug }}" class="img-thumbnail" width="100" height="100"/>
                                @else
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="date" name="startdate" id="startdate" class="form-control form-control-sm rounded-0" value="{{old('startdate', $post->startdate)}}"/>
                        </div>

                        <div class="col-md-6 form-group mb-3">
                            <label for="enddate">End Date <span class="text-danger">*</span></label> 
                            <input type="date" name="enddate" id="enddate" class="form-control form-control-sm rounded-0" value="{{old('enddate', $post->enddate)}}"/>
                        </div>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" placeholder="Enter Leave Title" value="{{old('title', $post->title)}}"/>
                        </div>
